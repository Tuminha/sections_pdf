...
print(f"Discussion: {discussion_for_ai}")

prompt_discussion = f"""Critically evaluate the discussion of this scientific article: {discussion_for_ai}
...
user_message = {
    "role": "user",
    "content": prompt_discussion
    }

# Use the AI agent to analyze the discussion
print(prompt_discussion) 
